...
3. After the greeting, open the first line with something that feels specific to ${companyName} or their industry — a genuine observation, a shared value, or a compliment that feels human. Do NOT open the body with the fest name or your name.
4. Keep it SHORT — max 150 words in the body (excluding greeting and sign-off). Busy people don't read long emails.
5. The email should sound like it was written by a real student, not a template or AI. No corporate jargon.
6. End the body with ONE simple, low-pressure ask — like "Would you be open to a 10-minute call?" or "Can I send you more details?" — not "please sponsor us".
...
[email body — compelling opening, fest pitch, soft ask]

Warm regards,
[sender's name from the fest committee — make up a realistic student name if not provided]
${festName} Sponsorship Committee
